...
//               icon: "📍",
//               title: "Our Address",
//               text: "Amarnagar faridabad haryana - 121003",
//             },
//             {
//               icon: "✉️",
//               title: "Email Us",
...
import "bootstrap/dist/css/bootstrap.min.css";
import { Fade, Slide } from "react-awesome-reveal";
import { sendContactMessage } from "../services/apiService"; // ✅ Import your API function
...
const ContactUs = () => {
  ...
  return (
    <section className="py-5" style={{ backgroundColor: "transparent", textAlign: "center" }}>
      <div className="container">
        {/* 🔹 Section Title */}
        <Fade triggerOnce>
          <h2
        ...
        <div className="row justify-content-center mb-5">
          {[
            { icon: "📍", title: "Our Address", text: "Amarnagar faridabad haryana - 121003" },
            { icon: "✉️", title: "Email Us", text: "Info@smigc.in" },
            { icon: "📞", title: "Call Us", text: "8982261363" },
          ].map((item, i) => (
            <div key={i} className="col-md-4 col-sm-6 mb-4">
              <Fade direction="up" triggerOnce delay={i * 150}>
                <div className="d-flex flex-column align-items-center p-3">
                  <div style={{ fontSize: "2.5rem", color: "#00BFFF", marginBottom: "10px" }}>
                    {item.icon}
                  </div>
                  <h5 className="fw-bold mb-2">{item.title}</h5>
        ...
        <div className="row justify-content-center align-items-start">
          ...
          <div className="col-md-6" style={{ height: "300px" }}>
            <Slide direction="right" triggerOnce>
              <form
                className="p-4 bg-white rounded shadow-sm d-flex flex-column"
                style={{ textAlign: "left", height: "100%", justifyContent: "space-between" }}
